...
ggplot(eva, aes(x = sel, col = sel)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  facet_grid(~ harmony, labeller = \(.) label_both(.)) 
  #geom_hline(yintercept = harm_tlisi, linetype = "dashed", color = "black")
```
...
ggplot(eva, aes(x = sel, col = sel)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  facet_grid(~ harmony, labeller = \(.) label_both(.)) 
  #geom_hline(yintercept = harm_slisi, linetype = "dashed", color = "black")
```
:::
